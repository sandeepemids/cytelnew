...
import './adaptation-rules.css';

class AdaptationRules extends Component {
  constructor(props) {
    super(props);
  }
...
transformErrors=(errors) => {
 ...
 CustomFieldTemplate=(props)=> {
  ...
  return (
    <Row className="adaptation-rules-fields">
       <Col>
  ...
  render() {
    ...
    return (
        <div className="adaptation-rules-form">
        <Form 
