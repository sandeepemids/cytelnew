...
{
    public class SimulationDBManager : ISimulationDBManager
    {
        private SimulationDBHandlerFactory dbFactory;
        private ISimulationDBHandler database;

        public SimulationDBManager(string connectionString)
        {
            dbFactory = new SimulationDBHandlerFactory(connectionString);
        ...
        {
            return SimulationParameterManager.CreateParameter(name, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, int size, object value, DbType dbType)
        {
            return SimulationParameterManager.CreateParameter(name, size, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, object value, NpgsqlDbType dbType, ParameterDirection direction)
        {
            return SimulationParameterManager.CreateParameter(name, value, dbType, direction);
        }
