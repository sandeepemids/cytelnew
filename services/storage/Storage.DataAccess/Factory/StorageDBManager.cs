...
{
    public class StorageDBManager : IStorageDBManager
    {
        private StorageDBHandlerFactory dbFactory;
        private IStorageDBHandler database;

        public StorageDBManager(string connectionString)
        {
            dbFactory = new StorageDBHandlerFactory(connectionString);
        ...
        {
            return StorageParameterManager.CreateParameter(name, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, int size, object value, DbType dbType)
        {
            return StorageParameterManager.CreateParameter(name, size, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, int size, object value, DbType dbType, ParameterDirection direction)
        {
            return StorageParameterManager.CreateParameter(name, size, value, dbType, direction);
        }
