...
{
    public class DataAugmentationDBManager : IDataAugmentationDBManager
    {
        private DataAugmentationDBHandlerFactory dbFactory;
        private IDataAugmentationDBHandler database;

        public DataAugmentationDBManager(string connectionString)
        {
            dbFactory = new DataAugmentationDBHandlerFactory(connectionString);
        ...
        {
            return DataAugmentationParameterManager.CreateParameter(name, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, int size, object value, DbType dbType)
        {
            return DataAugmentationParameterManager.CreateParameter(name, size, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(string name, int size, object value, DbType dbType, ParameterDirection direction)
        {
            return DataAugmentationParameterManager.CreateParameter(name, size, value, dbType, direction);
        }
